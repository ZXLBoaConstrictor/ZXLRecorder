#
#  Be sure to run `pod spec lint ZXLRecorder.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/ZXLBoaConstrictor/ZXLRecorder"
  ...
  # Or just: s.author    = "zhangxiaolong"
  # s.authors            = { "zhangxiaolong" => "244061043@qq.com" }
